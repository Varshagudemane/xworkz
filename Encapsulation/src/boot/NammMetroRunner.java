...
import app.NammMetro;

public class NammMetroRunner {
	public static void main(String[] args) {
		NammMetro myMetroTicket = new NammMetro();

		myMetroTicket.setUserName("Shashi");
		myMetroTicket.setFullName("Shashank N");
		myMetroTicket.setEmail("shashi@gmail.com");
		myMetroTicket.setPhoneNumber("+7899792081");
		myMetroTicket.setSourceStation("RajajiNagar");
		myMetroTicket.setDestinationStation("jaynagar");
