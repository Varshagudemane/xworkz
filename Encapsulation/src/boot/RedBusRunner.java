...
public class RedBusRunner {
	public static void main(String[] args) {
		...
		myRedBusBooking.setUserName("varsha");
		myRedBusBooking.setFullName("varshabr");
		myRedBusBooking.setEmail("varsha@gmail.com");
		myRedBusBooking.setPhoneNumber("+7760622942");
		myRedBusBooking.setBoardingPoint("Shimoga");
